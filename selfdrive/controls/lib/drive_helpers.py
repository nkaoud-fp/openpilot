  ...
  def update_v_cruise(self, CS, enabled, is_metric, speed_limit_changed, frogpilot_toggles):
    ...
    if CS.cruiseState.available:
      if not self.CP.pcmCruise:
        ...
        self.v_cruise_kph = self.v_cruise_kph_last # CS.cruiseState.speed * CV.MS_TO_KPH
        self.v_cruise_cluster_kph = self.v_cruise_kph_last # CS.cruiseState.speedCluster * CV.MS_TO_KPH
