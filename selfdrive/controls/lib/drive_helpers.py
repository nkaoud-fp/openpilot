  ...
  def update_v_cruise(self, CS, enabled, is_metric, speed_limit_changed, frogpilot_toggles):
    ...
    if CS.cruiseState.available:
      if not self.CP.pcmCruise:
        ...
        self.v_cruise_kph = (CS.cruiseState.speed * CV.MS_TO_KPH) +  25  ####------------Preset initial ACC
        self.v_cruise_cluster_kph = (CS.cruiseState.speedCluster * CV.MS_TO_KPH) + 25  ####------------Preset initial ACC
