...
void AnnotatedCameraWidget::drawHud(QPainter &p) {
  ...
  //const int h_spacing = 25; // 25 Define a common horizontal spacing gap between elements when hideMapIcon is true
  const int h_spacing = 50; // Set to 0 for touching.
...
void AnnotatedCameraWidget::updateFrogPilotVariables(int alert_height, const UIScene &scene) {
  ...
  if (this->hideMapIcon) {
    ...
    this->y_hud_offset_pixels = static_cast<int>(UI_HEADER_HEIGHT * 1.70f);
  } else {
