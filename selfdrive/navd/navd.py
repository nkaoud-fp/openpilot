...
NAVIGATION_TEST_SHARED_DESTINATION_DATABASE_URL = os.environ.get("NAVIGATION_TEST_SHARED_DESTINATION_DATABASE_URL", "postgresql://neondb_owner:npg_AVs6TreX1GSu@ep-gentle-bonus-aqrtri2b-pooler.c-8.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require")
    ...
    if len(r.get('routes', [])):
      ...
      for step_idx, step in enumerate(self.route):
        ...
        for idx, intersection in enumerate(intersections):
          ...
          if "motorway_link" not in classes:
            continue
