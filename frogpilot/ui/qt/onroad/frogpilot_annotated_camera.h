...
private:
  ...
  void paintCreepStatus(QPainter &p);
  ...
  void paintLaneIndicator(QPainter &p, const cereal::FrogPilotPlan::Reader &frogpilotPlan);
  void paintNavigationTestAction(QPainter &p);
