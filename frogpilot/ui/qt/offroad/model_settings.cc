...
bool hasAllTinygradFiles(const QDir &modelDir, const QString &modelKey) {
  const QStringList legacySuffixes = {
  ...
  const QStringList splitPolicySuffixes = {
    "_driving_policy_metadata.pkl",
    "_driving_policy_tinygrad.pkl",
    "_driving_off_policy_metadata.pkl",
    "_driving_off_policy_tinygrad.pkl",
    "_driving_vision_metadata.pkl",
    "_driving_vision_tinygrad.pkl",
  };

  const QStringList splitOnPolicySuffixes = {
    "_driving_on_policy_metadata.pkl",
    "_driving_on_policy_tinygrad.pkl",
    "_driving_off_policy_metadata.pkl",
    "_driving_off_policy_tinygrad.pkl",
    "_driving_vision_metadata.pkl",
    "_driving_vision_tinygrad.pkl",
  ...
  auto hasAll = [&](const QStringList &suffixes) {
  ...
  return hasAll(legacySuffixes) || hasAll(splitPolicySuffixes) || hasAll(splitOnPolicySuffixes);
}
