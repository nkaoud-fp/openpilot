...
FrogPilotLongitudinalPanel::FrogPilotLongitudinalPanel(FrogPilotSettingsWindow *parent) : FrogPilotListWidget(parent), parent(parent) {
  ...
  for (const auto &[param, title, desc, icon] : longitudinalToggles) {
    ...
    // ADDED: Create Dynamic Personality Controls
      ...
      FrogPilotParamValueControl *maxControl = new FrogPilotParamValueControl("dy_dynamic_follow_max", tr("Max"), tr("Maximum 'Follow' value."), "", 0.1, 3.0, tr("s"), std::map<float, QString>(), 0.01, true, 10);
      ...
      FrogPilotParamValueControl *maxControl = new FrogPilotParamValueControl("dy_dynamic_jerk_acceleration_max", tr("Max"), tr("Maximum 'Accel Jerk' value."), "", 0.1, 3.0, "", std::map<float, QString>(), 0.01, true, 10);
      longitudinalToggle = reinterpret_cast<AbstractControl*>(new FrogPilotDualParamValueControl(minControl, maxControl));
      ...
      FrogPilotParamValueControl *maxControl = new FrogPilotParamValueControl("dy_dynamic_jerk_deceleration_max", tr("Max"), tr("Maximum 'Decel Jerk' value."), "", 0.1, 3.0, "", std::map<float, QString>(), 0.01, true, 10);
      longitudinalToggle = reinterpret_cast<AbstractControl*>(new FrogPilotDualParamValueControl(minControl, maxControl));
      ...
      FrogPilotParamValueControl *maxControl = new FrogPilotParamValueControl("dy_dynamic_jerk_speed_max", tr("Max"), tr("Maximum 'Speed Jerk' value."), "", 0.1, 3.0, "", std::map<float, QString>(), 0.01, true, 10);
      longitudinalToggle = reinterpret_cast<AbstractControl*>(new FrogPilotDualParamValueControl(minControl, maxControl));
      ...
      FrogPilotParamValueControl *maxControl = new FrogPilotParamValueControl("dy_dynamic_jerk_speed_decrease_max", tr("Max"), tr("Maximum 'Speed Decel Jerk' value."), "", 0.1, 3.0, "", std::map<float, QString>(), 0.01, true, 10);
      longitudinalToggle = reinterpret_cast<AbstractControl*>(new FrogPilotDualParamValueControl(minControl, maxControl));
      ...
      FrogPilotParamValueControl *maxControl = new FrogPilotParamValueControl("dy_dynamic_jerk_danger_max", tr("Max"), tr("Maximum 'Danger Jerk' value."), "", 0.1, 3.0, "", std::map<float, QString>(), 0.01, true, 10);
      longitudinalToggle = reinterpret_cast<AbstractControl*>(new FrogPilotDualParamValueControl(minControl, maxControl));
