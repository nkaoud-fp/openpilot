...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"CreepAccel", PERSISTENT},
    {"CreepGapTarget", PERSISTENT},
    {"CreepMaxSpeed", PERSISTENT},
    {"CreepToGap", PERSISTENT},
    ...
    {"NavigationTestControl", CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION},
    {"NavigationTestCurrentLog", CLEAR_ON_MANAGER_START},
    {"NavigationTestDriveLogging", PERSISTENT},
    {"NavigationTestAutoEmail", PERSISTENT},
    {"NavigationTestHighwayPrepDistanceMax", PERSISTENT},
    {"NavigationTestHighwayPrepDistanceMin", PERSISTENT},
    {"NavigationTestEmailFrom", PERSISTENT},
    {"NavigationTestEmailLastStatus", PERSISTENT},
    {"NavigationTestEmailPendingLog", PERSISTENT},
    {"NavigationTestEmailSMTPHost", PERSISTENT},
    {"NavigationTestEmailSMTPPassword", PERSISTENT | DONT_LOG},
    {"NavigationTestEmailSMTPPort", PERSISTENT},
    ...
    {"NavigationTestPrepStatus", CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION},
    ...
    {"CreepUIData", CLEAR_ON_MANAGER_START},
    ...
    {"ExperimentalAccelFloor", PERSISTENT},
    {"ExperimentalAssertHeadroom", PERSISTENT},
    {"ExperimentalSpeedAssertiveness", PERSISTENT},
    ...
    {"LongDebugShowACtrl", PERSISTENT},
    {"LongDebugShowAEgo", PERSISTENT},
    {"LongDebugShowCap", PERSISTENT},
    {"LongDebugShowConfidence", PERSISTENT},
    {"LongDebugShowDesiredD", PERSISTENT},
    {"LongDebugShowDRel", PERSISTENT},
    {"LongDebugShowE2e", PERSISTENT},
    {"LongDebugShowEngProb", PERSISTENT},
    {"LongDebugShowFinal", PERSISTENT},
    {"LongDebugShowMaxA", PERSISTENT},
    {"LongDebugShowMinA", PERSISTENT},
    {"LongDebugShowMpc", PERSISTENT},
    {"LongDebugShowReq", PERSISTENT},
    ...
    {"SNGHack", PERSISTENT},
    {"SoftExperimentalBaselineCap", PERSISTENT},
    {"SoftExperimentalBaseStepFast", PERSISTENT},
    {"SoftExperimentalBaseStepSlow", PERSISTENT},
    {"SoftExperimentalDistanceBuffer", PERSISTENT},
    {"SoftExperimentalModeBraking", PERSISTENT},
